...
@class ZZDouYuRoom,ZZDouYuCdnswithname;
@interface ZZDouYUBannerModel : NSObject
...
@property (nonatomic, strong) ZZDouYuRoom *room;

@end
@interface ZZDouYuRoom : NSObject
...
@property (nonatomic, strong) NSArray<ZZDouYuCdnswithname *> *cdnsWithName;
...
@interface ZZDouYuCdnswithname : NSObject
