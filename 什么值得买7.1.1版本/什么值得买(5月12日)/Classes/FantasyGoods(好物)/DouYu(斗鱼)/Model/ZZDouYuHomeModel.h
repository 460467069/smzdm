...
@class ZZDouYURoom_List;
@interface ZZDouYuHomeModel : NSObject
...
@property (nonatomic, strong) NSArray<ZZDouYURoom_List *> *room_list;

@end
@interface ZZDouYURoom_List : NSObject
