...
#import "HMFantasticGoodsController.h"
#import "SDCycleScrollView.h"
#import "HMDouYUBannerModel.h"
#import "HMDouYuHomeModel.h"
...
@interface HMFantasticGoodsController ()<SDCycleScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation HMFantasticGoodsController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[HMDouYuHomeTableViewCell class] forCellReuseIdentifier:kHMDouYuHomeTableViewCell];
...
- (void)handelDouYuBannelData:(NSArray *)dataArray{
    ...
    NSArray *modelArray = [HMDouYUBannerModel mj_objectArrayWithKeyValuesArray:dataArray];
    NSMutableArray *imageURLStringsGroup = [NSMutableArray array];
    NSMutableArray *titlesGroup = [NSMutableArray array];
    
    for (HMDouYUBannerModel *model in modelArray) {
...
- (void)handelDouYuHomeData:(NSArray *)dataArray{
    ...
    self.roomListArrayM = [HMDouYuHomeModel mj_objectArrayWithKeyValuesArray:dataArray];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section{
    ...
    if ([collectionView isEqual:self.bannerCollectionView]) {
        ...
        HMDouYuHomeModel *bannelModel = self.roomListArrayM[[(AFIndexedCollectionView *)collectionView indexPath].row];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([collectionView isEqual:self.bannerCollectionView]) {
        HMDouYuBannerCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"HMDouYuBannerCell" forIndexPath:indexPath];
        ...
        HMDouYuHomeCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kCollectionViewCellIdentifier forIndexPath:indexPath];
        
        HMDouYuHomeModel *bannelModel = self.roomListArrayM[[(AFIndexedCollectionView *)collectionView indexPath].row];
        
        
        HMDouYURoom_List *listModel = bannelModel.room_list[indexPath.item];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HMDouYuHomeTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kHMDouYuHomeTableViewCell forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(HMDouYuHomeTableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HMDouYuHomeModel *bannelModel = self.roomListArrayM[indexPath.row];
