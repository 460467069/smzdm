...
@implementation HMHomeFirstLayout
...
- (void)_layoutTitle{
    HMHomeFirstModel *firstModel = self.firstModel;
...
- (void)_layoutScroll{
    ...
    for (HMFloorYuanchuangMaster *master in self.firstModel.floor_yuanchuang_master) {
