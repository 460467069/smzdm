...
@implementation HMDetailTopicHeaderLayout
...
- (void)layout {
    ...
    if (_detailTopicModel.focus_pic.length) {
        _imageHeight = 150;
    }
    
    NSMutableAttributedString *articleText = [NSMutableAttributedString new];
    {
        NSString *title = [NSString stringWithFormat:@"%@", _detailTopicModel.title];
    ...
    {
        NSString *title = [NSString stringWithFormat:@"%@", _detailTopicModel.brief];
        NSMutableDictionary *attributes = [NSMutableDictionary dictionary];
        [attributes setObject:kGlobalGrayColor forKey:NSForegroundColorAttributeName];
    ...
    HMTextLinePositionModifier *modifier = [[HMTextLinePositionModifier alloc] init];
