...
#define IMAGE_VIEW_ICON_CORNER_RADIUS           4.0f
#define IMAGE_VIEW_ICON_FRAME                   CGRectMake(8.0f, 8.0f, 36.0f, 36.0f)
#define DRAG_HANDLER_FRAME                      CGRectMake([[UIScreen mainScreen] bounds].size.width/2-30,NOTIFICATION_VIEW_FRAME_HEIGHT-5,60,3)
#define LABEL_TITLE_FRAME                       CGRectMake(50.0f, 3.0f, [[UIScreen mainScreen] bounds].size.width - 50.0f, 26.0f)
...
#define LABEL_MESSAGE_FRAME                     CGRectMake(50.0f, 25.0f, [[UIScreen mainScreen] bounds].size.width - 50.0f, LABEL_MESSAGE_FRAME_HEIGHT)
