...
#ifndef YYBBDateFormatterFactory_CACHE_LIMIT
#define YYBBDateFormatterFactory_CACHE_LIMIT 15
#endif

@implementation YYBBDateFormatterFactory
...
- (id)init {
    ...
    if (self) {
        ...
        loadedDataFormatters.countLimit = YYBBDateFormatterFactory_CACHE_LIMIT;
    }
    return self;
}
...
+ (YYBBDateFormatterFactory *)sharedFactory {
    static YYBBDateFormatterFactory *sharedInstance = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        sharedInstance = [[YYBBDateFormatterFactory alloc] init];
    });
