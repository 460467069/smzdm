...
@interface JXBWebViewController : YYBBBaseViewController<YYBBViewControllerDelegate>
@property (nonatomic, weak) JXBWKWebView                        *webView;           //当前Web控件
...
@property (nonatomic, assign) BOOL yy_prefersNavigationBarHidden;
@property (nonatomic, assign) CGFloat yy_leftOrRightViewTopOffset;
/**
